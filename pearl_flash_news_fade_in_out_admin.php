<?php $default_pearl_flash_news_fade_in_out_content = get_option('pearl_flash_news_fade_in_out_content');
      ...
      <form method="post">    
           ...
           <input type="text" name="pearl_flash_news_fade_in_out_height" value="<?php echo $default_pearl_flash_news_fade_in_out_height;?>"/>
           <label for="pearl_flash_news_fade_in_out_width">Width :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_width" value="<?php echo $default_pearl_flash_news_fade_in_out_width;?>"/><br/>
           <label for="pearl_flash_news_fade_in_out_bg_color">Bg Color :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_bg_color" value="<?php echo $default_pearl_flash_news_fade_in_out_bg_color;?>"/>       
           <label for="pearl_flash_news_fade_in_out_padding">Padding :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_padding" value="<?php echo $default_pearl_flash_news_fade_in_out_padding;?>"/>
           <label for="pearl_flash_news_fade_in_out_border_width">Border Width :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_border_width" value="<?php echo $default_pearl_flash_news_fade_in_out_border_width;?>"/><br/>
           <label for="pearl_flash_news_fade_in_out_border_color">Border Color :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_border_color" value="<?php echo $default_pearl_flash_news_fade_in_out_border_color;?>"/>      
           <label for="pearl_flash_news_fade_in_out_font_color">Font Color :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_font_color" value="<?php echo $default_pearl_flash_news_fade_in_out_font_color;?>"/>
           <label for="pearl_flash_news_fade_in_out_font_size">Font Size :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_font_size" value="<?php echo $default_pearl_flash_news_fade_in_out_font_size;?>"/><br/>
           <label for="pearl_flash_news_fade_in_out_letter_spacing">Letter Spacing :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_letter_spacing" value="<?php echo $default_pearl_flash_news_fade_in_out_letter_spacing;?>"/>
           <label for="pearl_flash_news_fade_in_out_delay">Delay :</label>
           <input type="text" name="pearl_flash_news_fade_in_out_delay" value="<?php echo $default_pearl_flash_news_fade_in_out_delay;?>"/><br/><br/>
           <label for="pearl_flash_news_fade_in_out_content">Enter Flashing News :(Enter flash news here and use -- as separator)</label><br/>
           <textarea rows="8" cols="50" name="pearl_flash_news_fade_in_out_content" ><?php echo $default_pearl_flash_news_fade_in_out_content;?></textarea><br/>
           <h3>Read More Settings</h3>
            <label for="pearl_flash_news_fade_in_out_read_more">Show Read More :</label>
           <input type="radio" name="pearl_flash_news_fade_in_out_read_more" value="yes"<?php echo $default_pearl_flash_news_fade_in_out_read_more;?> /> Yes <input type="radio" name="pearl_flash_news_fade_in_out_read_more" value="no"<?php echo $default_pearl_flash_news_fade_in_out_read_more;?> /> No<br/>
           <label for="pearl_news_flash_font_color_read_more">Read More Color :</label>
           <input type="text" name="pearl_news_flash_font_color_read_more" value="<?php echo $default_pearl_news_flash_font_color_read_more;?>"/><br/>
           
           <label for="pearl_news_flash_read_more_new_window">Show Read More (New Window) :</label>
           <input type="radio" name="pearl_news_flash_read_more_new_window" value="yes"<?php echo $default_pearl_news_flash_read_more_new_window;?> /> Yes <input type="radio" name="pearl_news_flash_read_more_new_window" value="no"<?php echo $default_pearl_news_flash_read_more_new_window;?> /> No<br/>
          ...
          <br/>
           ...
           <textarea rows="8" cols="50" name="pearl_flash_news_fade_in_out_links" ><?php echo $default_pearl_flash_news_fade_in_out_links;?></textarea><br/>       
